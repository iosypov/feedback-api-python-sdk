...
from feedbackapi.http.auth.custom_header_authentication import CustomHeaderAuthentication
from feedbackapi.controllers.credentials_controller\
    import CredentialsController
from feedbackapi.controllers.feedback_controller import FeedbackController


class FeedbackapiClient(object):
    ...
    @LazyProperty
    def feedback(self):
        return FeedbackController(self.global_configuration)
